...
public class LoginActivity extends StoryActivityBase{
	...
	//static final int MAX_SECURITY = Integer.MAX_VALUE;		// CHANGED TO REMOVE MAX_SECURITY VALUE AS ITS NOT NEEDED
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48
				...
				StorageUtilities.SECURITY_PRIVATE,				// CHANGED TO SAVE TO PRIVATE SECURITY 
				"login.txt");
	}
